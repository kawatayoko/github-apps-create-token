...
export PRIVATE_KEY=$(cat ~/.ssh/cross-repo-access-for-kawatayoko.2026-01-17.private-key.pem)
...
gh secret set PRIVATE_KEY < ~/.ssh/cross-repo-access-for-kawatayoko.2026-01-17.private-key.pem